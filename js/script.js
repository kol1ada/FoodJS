...
window.addEventListener('DOMContentLoaded', function () {
    ...
    class MenuCard {
        constructor(src, alt, title, descr, price, parentSelecrot, ...clases) {
            this.src = src;
            this.alt = alt;
            this.title = title;
            this.descr = descr;
            ...
            this.transfer = 45;
            this.clases = clases;
            this.parent = document.querySelector(parentSelecrot);
            this.changeToUAH();
        }
    ...
    const message = {
        ...
        success: 'Success, we take your data :D',
        failure: 'Sorry, we have problem :(',
    }
